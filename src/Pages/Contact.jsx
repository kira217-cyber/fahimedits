    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100 py-8">
      ...
      >
        <div className="w-full md:w-1/2 p-4">
          <h2 className="text-3xl font-bold bg-gradient-to-r from-[#4E8EFF] to-[#A072FF] bg-clip-text text-transparent leading-tight mb-4 text-center md:text-left">
            GET IN TOUCH!
          </h2>
          ...
          <p className="text-gray-600 mb-6">
            For any issues or queries, please use the form below:
          </p>
          <div className="space-y-4">
            ...
            <button
              className={`w-full cursor-pointer bg-gradient-to-r from-[#4E8EFF] to-[#A072FF] text-white p-2 rounded-md font-bold ${
        ...
        <div className="w-full md:w-1/2 p-4 bg-gray-50 rounded-lg">
          <h3 className="text-xl font-semibold bg-gradient-to-r from-[#4E8EFF] to-[#A072FF] bg-clip-text text-transparent leading-tight mb-4">
            Here Our Usual Response Times
          </h3>
          ...
          <p className="text-gray-600 mb-4">
            Our team is based in the +5:30 GMT timezone and available from 9am –
            6am Monday to Friday.
          </p>
          <p className="text-gray-600 mb-4">
            We are a small team and encourage our staff to have time off which
            is why we expect slightly slower response times but on urgent
